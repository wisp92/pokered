...
.handleDirectionButtonPress
	...
	callba Determine180degreeMove	;gbcnote - moved to func_overworld.asm to save space
...
CheckMapConnections::	;gbcnote - these routines moved to func_overworld.asm to save space
